...
<body>
	...
	<div class="imagediv">
		...
		<form action="viewuserbyemail" onsubmit="close()">
			<h2 style="color: green;">User Credentials</h2>
			<%
			...
			if(codeObj!=null){
				...
				if(code==0){
			%>
			<h2 style="color: blue; text-decoration: underline;text-decoration-color: aliceblue;">Email Not
				Found</h2>
			<%}} %>
			<input type="text" name="email" placeholder="Enter user-email"
				style="text-align: center;" required="required"><br> <br> <input
				type="submit" name="">
		</form>
