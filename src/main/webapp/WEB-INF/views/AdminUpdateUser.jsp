...
<div class="imagediv">
		<form action="adminupdateuserdata">
				<h2 style="margin: 0px; padding: 10px; background: red; border-radius: 10px; text-shadow: 2px 5px 3px greenyellow;" >User Details</h2><br>
				ID : <br>
				<input type="number" name="id"  value="<%= user.getId() %>" readonly="readonly"><br><br>
				Name : <br>
				<input type="text" name="name"  value="<%= user.getName()%>"><br><br>
				Age : <br>
				<input type="number" name="age" value="<%= user.getAge()%>"><br><br>
				Email : <br>
				<input type="text" name="email"  value="<%= user.getEmail()%>"><br><br>
				pin : 
				<br><input type="text" name="pin"  value="<%= user.getPin() %>" readonly="readonly"><br><br>
				Address : <br><textarea rows="3" name="address">${user.address } </textarea>
				<br><br>
